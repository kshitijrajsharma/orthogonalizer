...
with open("input.geojson", "w") as file:
    file.write(json.dumps(my_geojson))


orthogonalized_poly = othogonalize_poly(my_geojson)


with open("orthogonalized.geojson", "w") as file:
    file.write(json.dumps(orthogonalized_poly))
